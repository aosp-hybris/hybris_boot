...
int main(int argc, char **argv)
{
        ...
        if (!strcmp(basename(argv[0]), "run-init"))
         ...
         * crw------- 1 root root 5, 1 Mar 23 19:30 /dev/console
         * crw-rw-rw- 1 root root 1, 3 Mar 23 19:30 /dev/null
         * crw-rw-rw- 1 root root 1, 5 Mar 23 19:30 /dev/zero
         */
